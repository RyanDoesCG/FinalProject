 ...
 *
 *  ADAPTED TO C++ FROM: http://weber.itn.liu.se/~stegu/Worleynoise/Worleynoise.pdf
 *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#include "../../Headers/Engine/Noise/WorleyMachine.hpp"

void WorleyMachine::initialise() {
...
double WorleyMachine::noise(double xin, double yin, double zin) {
    // take random points in space (2- or 3-dimensional)
